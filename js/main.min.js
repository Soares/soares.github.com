...
(function(){var e,b;e=[];b=0;$(function(){var g,a,c,f,i,k,j,d;k=function(){return b=b||setInterval(d,0)};j=function(){e=[];a.removeClass("going").removeClass("paused");return b=clearInterval(b)};d=function(){var a,b,c,d;d=[];b=0;for(c=e.length;b<c;b++)a=e[b],d.push(a.step());return d};i=document.getElementById("canvas").getContext("2d");a=$("#controls");c=$("#fractals");g=$("body");$(window).resize(function(){i.canvas.width=window.innerWidth;i.canvas.height=window.innerHeight;return j()}).trigger("resize").click(function(b){a.is(".paused")&&
(e=[]);a.removeClass("paused").addClass("going");e.push(new f(i,b.pageX-document.body.scrollLeft,b.pageY-document.body.scrollTop,0,1));return k()});f=Fractals[g.attr("class")];$("button",a.add(c)).click(function(a){return a.stopPropagation()});$("button",c).click(function(){var a;a=$(this).button("toggle").data("fractal");f=Fractals[a];return g.removeClass().addClass(a)});$(".control",a).click(function(){if(a.is(".going"))return a.removeClass("going").addClass("paused"),b=clearInterval(b);a.removeClass("paused").addClass("going");
return k()});return $(".clear",a).click(function(){i.clearRect(0,0,i.canvas.width,i.canvas.height);return j()})})}).call(this);
