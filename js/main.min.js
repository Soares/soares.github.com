...
(function() {
  ...
  Fractal = (function() {
    ...
    Fractal.prototype.iterate = function(turtle, size, heading) {
      this.iterations++;
      if (this.cap > 0 && this.iterations >= this.cap) clearInterval(this.ticker);
    ...
    Fractal.prototype.start = function(tick) {
      return this.ticker = setInterval(this.step, tick);
    };
...
(function() {
  ...
  $(function() {
    var $body, $controls, $fractals, $window, Current, context, stop;
    stop = function() {
      var fractal, _i, _len;
    ...
    $('.control', $controls).click(function(e) {
      var fractal, _i, _j, _len, _len2, _results, _results2;
      if ($controls.is('.going')) {
        $controls.removeClass('going').addClass('paused');
        _results = [];
        for (_i = 0, _len = fractals.length; _i < _len; _i++) {
          fractal = fractals[_i];
          _results.push(fractal.stop());
        }
        return _results;
      } else {
        $controls.removeClass('paused').addClass('going');
        _results2 = [];
        for (_j = 0, _len2 = fractals.length; _j < _len2; _j++) {
          fractal = fractals[_j];
          _results2.push(fractal.start());
        }
        return _results2;
      }
    });
