...
b.x),c.attr("cy",b.y)};$(function(){f=$("#dot");c=$("#halo");b.x=parseFloat(f.attr("cx"));b.y=parseFloat(f.attr("cy"));$(window).mousemove(function(a){f.css("visibility","visible");c.css("visibility","visible");g.x=a.pageX-document.body.scrollLeft;return g.y=a.pageY-document.body.scrollTop});return setInterval(a,25)})}).call(this);
