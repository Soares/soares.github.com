...
(function() {
  ...
  this.ColorWheel = (function() {
    ...
    ColorWheel.prototype.value = function() {
      ...
      h = typeof this.h === "number" ? this.h : this.h.value(time);
      s = typeof this.s === "number" ? this.s : this.s.value(time);
      l = typeof this.l === "number" ? this.l : this.l.value(time);
...
(function() {
  ...
  Fractal = (function() {
    ...
    Fractal.prototype.cap = 0;

    function Fractal(pen, x, y, heading, size, die) {
      var turtle,
        _this = this;
      this.pen = pen;
      this.x = x;
    ...
    Fractal.prototype.step = function(skip) {
      ...
      if (typeof this.axiom === "string") return;
  ...
  Dragon = (function(_super) {
    ...
    Dragon.prototype.cap = 15;

    function Dragon(pen, x, y, heading, size, die) {
      this.step = __bind(this.step, this);
      this.reset = __bind(this.reset, this);      this.batching = 0;
      Dragon.__super__.constructor.call(this, pen, x, y, heading, size * 3, die);
    }
  ...
  Plant = (function(_super) {
    ...
    Plant.prototype.colors = new ColorWheel(new Oscilator(.67, .09, -.4, .23));

    Plant.prototype.cap = 8;

    function Plant(pen, x, y, heading, size, die) {
      this.reset = __bind(this.reset, this);      Plant.__super__.constructor.call(this, pen, x, y, heading + 1 / 4, size * 3, die);
    }
  ...
  Serpinsky = (function(_super) {
    ...
    Serpinsky.prototype.cap = 9;

    Serpinsky.prototype.reset = function() {};

    function Serpinsky(pen, x, y, heading, size, die) {
      this.reset = __bind(this.reset, this);
      var hue, theta;
      theta = (thits % 6) / 6;
      hue = (thits * .29) % 1;
      this.colors = new ColorWheel(new Oscilator(hue, .5, .265, .76));
      Serpinsky.__super__.constructor.call(this, pen, x, y, heading + theta, size, die);
      thits++;
    }
  ...
  Tree = (function(_super) {
    ...
    Tree.prototype.colors = new ColorWheel(new Oscilator(.80, .1, .6, .155));

    Tree.prototype.cap = 11;

    function Tree(pen, x, y, heading, size, die) {
      this.reset = __bind(this.reset, this);      Tree.__super__.constructor.call(this, pen, x, y, heading - 1 / 4, size * 6, die);
    }
...
(function() {
  var FPS, HEADING, SIZE, clear, fractals, id, speed, ticker;
  ...
  $(function() {
    ...
    $('#svg, #canvas, #dot, #halo').mouseup(function(e) {
      var die, x, y;
      e.stopPropagation();
...
(function() {
  ...
  $(function() {
    var doc;
    return doc = $.get('more.html', function(page) {
      return initialize($('#more', page));
    });
  });

  initialize = function($more) {
    var $back, $card, $forward;
    $card = $('#card');
    $card.after($more);
    this.glide($('#glider'));
    $forward = $('#to-more');
