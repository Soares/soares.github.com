...
e.x),a.attr("cy",e.y)};$(function(){c=$("#dot");a=$("#halo");e.x=parseFloat(c.attr("cx"));e.y=parseFloat(c.attr("cy"));$(window).mousemove(function(b){h.x=b.pageX-document.body.scrollLeft;return h.y=b.pageY-document.body.scrollTop});c.css("visibility","visible");a.css("visibility","visible");return setInterval(b,25)})}).call(this);
